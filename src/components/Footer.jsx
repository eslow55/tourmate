    ...
    <footer className="footer">
      <div className="footer__container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            ...
            <p className="footer__text">
              Expertos en experiencias locales. Descubre la verdadera esencia de Medellín con guías apasionados y rutas auténticas.
            </p>
          ...
          <div className="footer__nav">
            ...
            <ul>
              ...
              <li><Link to="/login">Centro de ayuda</Link></li>
        ...
        <div className="footer__bottom">
          <p>© {new Date().getFullYear()} Tourmate Medellín. Hecho con ❤️ en la ciudad de la eterna primavera.</p>
        </div>
      </div>
    </footer>
  );
